...
class playerStats                                   //initializing class
{
    public:                                         //Public
        ...
        double copy()               //Calculates the burned calories using the inputed variables
        {
            return firstname, lastname, age, shotsTargetFor, shotsTargetAgainst,  missedShotsFor, missedShotsAgainst, met, bodyWeight;
        }
